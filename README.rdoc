...
* {OauthClient}[https://github.com/Lelylan/rest-oauth2-server/blob/master/app/models/oauth/oauth_client.rb]: represents the credentials of a client application.
