...
You can also decide to apply the OAuth Authorization Filter to all JSON API by uncommenting <tt>oauth_authorized</tt> 
in the {ApplicationController}[https://github.com/Lelylan/rest-oauth2-server/blob/development/app/controllers/application_controller.rb]
