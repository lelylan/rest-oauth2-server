...
API in a secure way. The actual implementation is based on {draft 13}[http://tools.ietf.org/html/draft-ietf-oauth-v2-13]
and it allows you to obtain the access tokens using one of the following 3 flows
