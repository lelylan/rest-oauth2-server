...
1) <b>Action based</b>. You can specify *any* action in a controller. For example if you want to allow the access 
...
2) <b>Scope name based</b>. You can specify any group of actions adding a name scope. For example if the scope pizzas
