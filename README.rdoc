...
Note that as values, for the pizzas, pastas and read scope we define the specific action that can be accessed, 
while for the all pizzas we use scope names already defined. This makes easier to mantain scopes.
