...
Redirect the user to https://example.com/oauth/authorize passing the following parameters in the query string

  https://oauthserver.com/oauth/authorize?
    response_type=code&
    client_id=https://oauthserver.com/client/example&
    redirect_uri=https://example.com/callback&
    scope=write

Lets explain in detail this URI

* https://oauthserver.com/oauth/authorize - the page where the resource owner will grant or deny the access
...
NOTE: To create a sample client go to the rails console and type Factory(:oauth_client). Soon there will be a UI
where you will be able to easily create your clients.
